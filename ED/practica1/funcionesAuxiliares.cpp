...
void ed::comprueba_potencia()
{
	...
	std::cout << BICYAN;
	std::cout << UPURPLE;
	std::cout<< "Escribe el monomio"<< std::endl<< std::endl;
	std::cout << RESET;

	m.leerMonomio();

	std::cout<<"Introduce la potencia del monomio: ";
	std::cin>>grado;
	std::cout << std::endl;
	...
	{		
		...
		while(grado < 0){
			...
			std::cout << BIRED;
			std::cout<< "El grado es negativo, introduzca de nuevo el grado: " << std::endl;
			std::cin>>grado;
			std::cout << RESET;
		}
	}
	...
	std::cout << BICYAN;
	std::cout << UPURPLE;
	std::cout<< "El monomio resultante es = ";
	std::cout << RESET;
