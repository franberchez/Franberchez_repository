...
void ed::testPolinomio()
{
  ...
  std::cout << "Quitar el comentario de bloque cuando se haya codificado la clase Polinomio " << std::endl << std::endl;
	...
	p3.escribirPolinomio();
	std::cout << std::endl;
	std::cout<< "Resultado p1 += p3"<< std::endl;
	p1 += p3;
	std::cout<< "p1 = ";
	p1.escribirPolinomio();
	std::cout << std::endl << std::endl;
...
// Operador de resta y asignación
	...
	ed::Polinomio p4;
	std::cout<<"Vamos a crear un nuevo polinomio:"<<std::endl;
	p4.leerPolinomio();
	std::cout<< "Operador p1 /= p4 "<< std::endl;
	if ((p1.getGrado() >= p4.getGrado()) and (not p4.esNulo()))
	{
		std::cout<< "p1 = ";
		p1.escribirPolinomio();
		std::cout << std::endl;
		...
		std::cout << std::endl;
		std::cout<< "Resultado p1 /= p4"<< std::endl;
		p1 /= p4;
		std::cout<< "p1 = ";
		p1.escribirPolinomio();
		std::cout << std::endl << std::endl;
